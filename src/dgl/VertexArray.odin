...
// vao_create :: proc {
//     vao_create_without_buffer,
//     vao_create_with_buffer,
// }

// vao_create_without_buffer :: proc(attributes: ..VertexAttribute) -> VertexArray {
//     vao : VertexArray
...
//         size := vao_get_attribute_size(count, type)
...
// vao_create_with_buffer :: proc(vertex_buffer, index_buffer: ^Buffer, attributes: ..VertexAttribute) -> VertexArray {
//     vao := vao_create_without_buffer(..attributes)

//     if vertex_buffer != nil do vao_attach_vertex_buffer(&vao, vertex_buffer, 0, vao.stride, 0)
//     if index_buffer != nil do vao_attach_index_buffer(&vao, index_buffer)
//     return vao
// }

// vao_attach_vertex_buffer :: proc(vertex_array: ^VertexArray, buffer: ^Buffer, offset, stride, binding_index : u32) {
//     vao_bind(vertex_array)
...
// }
// vao_attach_index_buffer :: proc(vertex_array: ^VertexArray, buffer: ^Buffer) {
//     vao_bind(vertex_array)
//     gl.VertexArrayElementBuffer(vertex_array.native_id, buffer.native_id)
// }

vao_destroy :: proc(vertex_array: ..^VertexArray) {
...
vao_bind :: proc(vertex_array: ^VertexArray) {
    if current_vertex_array != vertex_array do gl.BindVertexArray(vertex_array.native_id)
}

@(private="file") 
vao_get_attribute_size :: proc (#any_int count: u32, type: AttributeType) -> u32 {
    size : u32
    #partial switch type {
