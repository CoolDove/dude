...
foreign cimgui {
	...
	igColorEdit3                       :: proc(label: cstring, col: ^Vec3, flags: Color_Edit_Flags) -> bool ---;
	igColorEdit4                       :: proc(label: cstring, col: ^Vec4, flags: Color_Edit_Flags) -> bool ---;
	igColorPicker3                     :: proc(label: cstring, col: ^Vec3, flags: Color_Edit_Flags) -> bool ---;
	igColorPicker4                     :: proc(label: cstring, col: ^Vec4, flags: Color_Edit_Flags, ref_col: ^f32) -> bool ---;
	...
	igDragFloat2                       :: proc(label: cstring, v: ^Vec2, v_speed: f32, v_min: f32, v_max: f32, format: cstring, flags: Slider_Flags) -> bool ---;
	igDragFloat3                       :: proc(label: cstring, v: ^Vec3, v_speed: f32, v_min: f32, v_max: f32, format: cstring, flags: Slider_Flags) -> bool ---;
	igDragFloat4                       :: proc(label: cstring, v: ^Vec4, v_speed: f32, v_min: f32, v_max: f32, format: cstring, flags: Slider_Flags) -> bool ---;
	...
	igInputFloat2                      :: proc(label: cstring, v: ^Vec2, format: cstring, flags: Input_Text_Flags) -> bool ---;
	igInputFloat3                      :: proc(label: cstring, v: ^Vec3, format: cstring, flags: Input_Text_Flags) -> bool ---;
	igInputFloat4                      :: proc(label: cstring, v: ^Vec4, format: cstring, flags: Input_Text_Flags) -> bool ---;
	...
	igSliderFloat2                     :: proc(label: cstring, v: ^Vec2, v_min: f32, v_max: f32, format: cstring, flags: Slider_Flags) -> bool ---;
	igSliderFloat3                     :: proc(label: cstring, v: ^Vec3, v_min: f32, v_max: f32, format: cstring, flags: Slider_Flags) -> bool ---;
	igSliderFloat4                     :: proc(label: cstring, v: ^Vec4, v_min: f32, v_max: f32, format: cstring, flags: Slider_Flags) -> bool ---;
	igSliderInt                        :: proc(label: cstring, v: ^i32, v_min: i32, v_max: i32, format: cstring, flags: Slider_Flags) -> bool ---;
	igSliderInt2                       :: proc(label: cstring, v: ^Vec2i, v_min: i32, v_max: i32, format: cstring, flags: Slider_Flags) -> bool ---;
	igSliderInt3                       :: proc(label: cstring, v: ^Vec3i, v_min: i32, v_max: i32, format: cstring, flags: Slider_Flags) -> bool ---;
	igSliderInt4                       :: proc(label: cstring, v: ^Vec4i, v_min: i32, v_max: i32, format: cstring, flags: Slider_Flags) -> bool ---;
