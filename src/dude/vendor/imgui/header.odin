...
color_edit3                            :: #force_inline proc(label: string, col: ^Vec3, flags := Color_Edit_Flags(0)) -> bool                                                                                                     { return swr_igColorEdit3(label, col, flags); }
color_edit4                            :: #force_inline proc(label: string, col: ^Vec4, flags := Color_Edit_Flags(0)) -> bool                                                                                                     { return swr_igColorEdit4(label, col, flags); }
color_picker3                          :: #force_inline proc(label: string, col: ^Vec3, flags := Color_Edit_Flags(0)) -> bool                                                                                                     { return swr_igColorPicker3(label, col, flags); }
color_picker4                          :: #force_inline proc(label: string, col: ^Vec4, flags := Color_Edit_Flags(0), ref_col : ^f32 = nil) -> bool                                                                               { return swr_igColorPicker4(label, col, flags, ref_col); }
...
drag_float2                            :: #force_inline proc(label: string, v: ^Vec2, v_speed := f32(1.0), v_min := f32(0.0), v_max := f32(0.0), format := "%.3f", flags := Slider_Flags(0)) -> bool                              { return swr_igDragFloat2(label, v, v_speed, v_min, v_max, format, flags); }
drag_float3                            :: #force_inline proc(label: string, v: ^Vec3, v_speed := f32(1.0), v_min := f32(0.0), v_max := f32(0.0), format := "%.3f", flags := Slider_Flags(0)) -> bool                              { return swr_igDragFloat3(label, v, v_speed, v_min, v_max, format, flags); }
drag_float4                            :: #force_inline proc(label: string, v: ^Vec4, v_speed := f32(1.0), v_min := f32(0.0), v_max := f32(0.0), format := "%.3f", flags := Slider_Flags(0)) -> bool                              { return swr_igDragFloat4(label, v, v_speed, v_min, v_max, format, flags); }
...
input_float2                           :: #force_inline proc(label: string, v: ^Vec2, format := "%.3f", flags := Input_Text_Flags(0)) -> bool                                                                                     { return swr_igInputFloat2(label, v, format, flags); }
input_float3                           :: #force_inline proc(label: string, v: ^Vec3, format := "%.3f", flags := Input_Text_Flags(0)) -> bool                                                                                     { return swr_igInputFloat3(label, v, format, flags); }
input_float4                           :: #force_inline proc(label: string, v: ^Vec4, format := "%.3f", flags := Input_Text_Flags(0)) -> bool                                                                                     { return swr_igInputFloat4(label, v, format, flags); }
...
slider_float2                          :: #force_inline proc(label: string, v: ^Vec2, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                                 { return swr_igSliderFloat2(label, v, v_min, v_max, format, flags); }
slider_float3                          :: #force_inline proc(label: string, v: ^Vec3, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                                 { return swr_igSliderFloat3(label, v, v_min, v_max, format, flags); }
slider_float4                          :: #force_inline proc(label: string, v: ^Vec4, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                                 { return swr_igSliderFloat4(label, v, v_min, v_max, format, flags); }
...
slider_int2                            :: #force_inline proc(label: string, v: ^Vec2i, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                                   { return swr_igSliderInt2(label, v, v_min, v_max, format, flags); }
slider_int3                            :: #force_inline proc(label: string, v: ^Vec3i, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                                   { return swr_igSliderInt3(label, v, v_min, v_max, format, flags); }
slider_int4                            :: #force_inline proc(label: string, v: ^Vec4i, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                                   { return swr_igSliderInt4(label, v, v_min, v_max, format, flags); }
